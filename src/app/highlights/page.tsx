...
const H: HighlightDef[] = [
  // ── 1. BAPTISAN ──
  {
    ...
    contactQrs: [{ src: "/posters/qr-baptisan.png", label: "Daftar Baptisan", text: "helpbec.vercel.app/forms/baptism" }],
  },
  ...
  // ── 3. M-CLASS ──
  {
    ...
    contactQrs: [{ src: "/posters/qr-mclass.png", label: "Daftar M-Class", text: "helpbec.vercel.app/forms/mclass" }],
  },
  ...
  // ── 5. PENYERAHAN ANAK ──
  {
    ...
    contactQrs: [{ src: "/posters/qr-penyerahan-anak.png", label: "Daftar Penyerahan Anak", text: "helpbec.vercel.app/forms/child-dedication" }],
  },
