...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/formulir/doa', label: 'Pokok Doa', icon: HandHeart, permission: 'page:forms/prayer' },
      { href: '/admin/formulir/mclass', label: 'M-Class', icon: BookOpen, permission: 'page:forms/mclass' },
    ],
  },
  {
    label: 'Sistem',
    items: [
      { href: '/admin/pengaturan', label: 'Pengaturan Formulir', icon: Settings, permission: 'page:settings' },
      { href: '/admin/analitik', label: 'Analitik', icon: BarChart3, permission: 'page:analytics' },
      ...
      { href: '/admin/pertanyaan-tak-terjawab', label: 'Tak Terjawab', icon: MessageCircleQuestion, permission: 'page:chat-misses' },
      { href: '/admin/pengguna', label: 'Kelola Admin', icon: Users, permission: 'page:admin-users' },
